	...
	<div class="container">
		...
		<div class="main dir-row">
			...
			<div class="category-list">
				<a href="./book" class="category">
					<h4>Books</h4>
				</a> <a href="laptop" class="category">
					<h4>Laptops</h4>
				</a> <a href="shoe" class="category">
					<h4>Shoes</h4>
				</a>
			</div>
			...
			<div class="items">
				...
				<c:forEach items="${productList}" var="product">
					...
					<a href="../product/<c:out value='${product.productID}'/>">
						<div class="item">
							<div class="img">
								<img
